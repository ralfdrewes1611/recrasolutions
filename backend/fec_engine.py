...
FEC_SUPPLIERS = [
    ...
    {
        "id": "sup-ikdisplay",
        "name": "IK Display Solutions",
        "address": "Rotterdam, Nederland",
        "lat": 51.9244,
        "lng": 4.4777,
        "categories": ["entree", "interactive"],
        "specialization": "Indoor & outdoor kiosken, digitale informatiezuilen & ticketing displays",
        "price_per_km": 1.50,
        "start_fee": 200,
        "hourly_rate_travel": 65,
    },
...
FEC_PRODUCTS = [
    ...
    # === IK DISPLAY - INDOOR KIOSKEN (Ticketing, Wayfinding, Self-Service) ===
    {
        "name": "IK 21.5\" Indoor Portrait Kiosk (tilted)",
        "category": "entree",
        "supplier": "IK Display Solutions",
        "description": "21.5\" touchscreen kiosk schuin, self-service ticketing, QR check-in, camera. IP21",
        "footprint_m2": 1,
        "min_height_m": 2.0,
        "price_purchase": 3500,
    ...
    },
    {
        ...
        "category": "entree",
        "supplier": "IK Display Solutions",
        "description": "43\" touchscreen landscape kiosk, wayfinding & informatie, capacitive touch, speakers. IP21",
        "footprint_m2": 2,
        "min_height_m": 2.0,
        "price_purchase": 2500,
    ...
    },
    {
        ...
        "category": "entree",
        "supplier": "IK Display Solutions",
        "description": "55\" touchscreen portrait kiosk, self-service ticketing & upsell display, speakers. IP21",
        "footprint_m2": 2,
        "min_height_m": 2.0,
        "price_purchase": 2650,
